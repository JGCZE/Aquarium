...
export type EFishSpeed = 3 | 5 | 10 | 14 | 18 | 25

const useFish = (fishWidth: number, speed: EFishSpeed): IReturn => {
  ...
  const randomTurnTime = useMemo(() => RANDOM_TURN_BASE + Math.random() * RANDOM_TURN_VARIANCE, [ isFlipped ])
